...
const ROUTES: { group: string; path: string }[] = [
  ...
  { group: "gamma", path: "/api/gamma/stage-5/evidence" },
  { group: "gamma", path: "/api/gamma/stage-5/release-gate" },
  { group: "gamma", path: "/api/gamma/stage-5/promotion-checklist" },
  { group: "gamma", path: "/api/gamma/stage-5/deployment-summary" },
  { group: "gamma", path: "/api/gamma/stage-5/operator-brief" },
  { group: "gamma", path: "/api/gamma/stage-5/health" },
  { group: "gamma", path: "/api/gamma/stage-5/release-dashboard" },
  { group: "gamma", path: "/api/gamma/stage-5/api-manifest" },
  ...
  { group: "gamma", path: "/api/gamma/stage-5/rollback-plan" },
  { group: "gamma", path: "/api/gamma/stage-5/operator-handoff" },
  { group: "gamma", path: "/api/gamma/stage-5/audit-ledger" },
  { group: "gamma", path: "/api/gamma/stage-5/deployment-receipt" },
  { group: "gamma", path: "/api/gamma/stage-5/promotion-journal" },
  { group: "gamma", path: "/api/gamma/stage-5/operator-signoff" },
  { group: "gamma", path: "/api/gamma/stage-5/evidence-index" },
  { group: "gamma", path: "/api/gamma/stage-5/release-bundle" },
  { group: "gamma", path: "/api/gamma/stage-5/release-archive-manifest" },
  { group: "gamma", path: "/api/gamma/stage-5/release-retention-policy" },
  ...
  { group: "gamma", path: "/api/gamma/stage-5/release-approval-packet" },
  { group: "gamma", path: "/api/gamma/stage-5/release-promotion-plan" },
  { group: "gamma", path: "/api/gamma/stage-5/release-cutover-checklist" },
  { group: "gamma", path: "/api/gamma/stage-5/release-traffic-shift-plan" },
  { group: "gamma", path: "/api/gamma/stage-5/release-monitoring-plan" },
  { group: "gamma", path: "/api/gamma/stage-5/release-post-promotion-review" },
  { group: "gamma", path: "/api/gamma/stage-5/release-operations-index" },
  ...
  { group: "gamma", path: "/api/gamma/stage-5/release-operator-registry" },
  { group: "gamma", path: "/api/gamma/stage-5/release-operator-action-queue" },
  ...
  { group: "gamma", path: "/api/gamma/stage-5/release-production-cutover-packet" },
