...
describe("Gamma 2 Stage 5 SDK descriptor", () => {
  it("builds a governed SDK descriptor from the Stage 5 API manifest", () => {
    ...
    expect(sdk.endpointCount).toBe(GAMMA_STAGE_5_SURFACE_COUNTS.totalEndpoints);
  });
  ...
  it("keeps generated clients behind the manifest and OpenAPI boundary", () => {
    ...
    expect(sdk.endpoints).toContainEqual({
      ...
      method: "GET",
      operationId: "getStage5ReleaseCloseoutPacket",
      audience: "operator",
    });
    expect(sdk.endpoints).toContainEqual({
      path: "/api/gamma/stage-5/release-closure-ledger",
      method: "GET",
      operationId: "getStage5ReleaseClosureLedger",
      audience: "operator",
    });
    expect(sdk.endpoints).toContainEqual({
      path: "/api/gamma/stage-5/release-completion-certificate",
      method: "GET",
      operationId: "getStage5ReleaseCompletionCertificate",
      audience: "operator",
    });
    expect(sdk.endpoints).toContainEqual({
      path: "/api/gamma/stage-5/release-finalization-index",
      method: "GET",
      operationId: "getStage5ReleaseFinalizationIndex",
      audience: "operator",
    });
    expect(sdk.endpoints).toContainEqual({
      path: "/api/gamma/stage-5/release-operator-registry",
      method: "GET",
      operationId: "getStage5ReleaseOperatorRegistry",
      audience: "operator",
    });
    expect(sdk.endpoints).toContainEqual({
      path: "/api/gamma/stage-5/release-operator-action-queue",
      method: "GET",
      operationId: "getStage5ReleaseOperatorActionQueue",
      audience: "operator",
    });
    expect(sdk.endpoints).toContainEqual({
      path: "/api/gamma/stage-5/release-operator-approval-packet",
      method: "GET",
      operationId: "getStage5ReleaseOperatorApprovalPacket",
      audience: "operator",
    });
    expect(sdk.endpoints).toContainEqual({
      path: "/api/gamma/stage-5/release-operator-approval-audit-trail",
      method: "GET",
      operationId: "getStage5ReleaseOperatorApprovalAuditTrail",
      audience: "operator",
    });
    expect(sdk.endpoints).toContainEqual({
    ...
    expect(sdk.endpoints).toContainEqual({
      ...
      method: "GET",
      operationId: "getStage5ReleaseProductionCutoverPacket",
      audience: "operator",
    });
