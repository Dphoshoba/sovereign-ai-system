...
export const SharePointClient: ApiClient = {
  ...
  quotaDefinitions: [
    { name: "sites.read", limit: 100000, windowSeconds: 86400 },
    { name: "sites.write", limit: 10000, windowSeconds: 86400 },
  ] satisfies QuotaDefinition[],
  async read(_resource: string, _params?: Record<string, string>): Promise<unknown> {
    throw new Error("SharePointClient.read is not implemented.");
  },
  async create(_resource: string, _payload: unknown): Promise<unknown> {
    throw new Error("SharePointClient.create is not implemented.");
  },
  async update(_resource: string, _id: string, _payload: unknown): Promise<unknown> {
    throw new Error("SharePointClient.update is not implemented.");
  },
  async delete(_resource: string, _id: string): Promise<void> {
    throw new Error("SharePointClient.delete is not implemented.");
  },
};
