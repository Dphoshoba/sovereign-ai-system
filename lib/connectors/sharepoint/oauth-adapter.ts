...
export const SharePointOAuth: OAuthAdapter = {
  authorizationUrl: "https://login.microsoftonline.com/common/oauth2/v2.0/authorize",
  tokenUrl: "https://login.microsoftonline.com/common/oauth2/v2.0/token",
  requiredScopes: ["Sites.Read.All", "Files.Read.All"],
  highRiskScopes: ["Sites.ReadWrite.All", "Files.ReadWrite.All"],
  async exchangeCode(_code: string): Promise<TokenSet> {
    throw new Error("SharePointOAuth.exchangeCode is not implemented.");
  },
  async refreshToken(_refreshToken: string): Promise<TokenSet> {
    throw new Error("SharePointOAuth.refreshToken is not implemented.");
  },
