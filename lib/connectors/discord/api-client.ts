...
export const DiscordClient: ApiClient = {
  serviceName: "Discord",
  ...
  quotaDefinitions: [
    { name: "guild.read", limit: 10000, windowSeconds: 86400 },
    { name: "message.write", limit: 1000, windowSeconds: 86400 },
  ] satisfies QuotaDefinition[],
  async read(_resource: string, _params?: Record<string, string>): Promise<unknown> {
    throw new Error("DiscordClient.read is not implemented.");
  },
  async create(_resource: string, _payload: unknown): Promise<unknown> {
    throw new Error("DiscordClient.create is not implemented.");
  },
  async update(_resource: string, _id: string, _payload: unknown): Promise<unknown> {
    throw new Error("DiscordClient.update is not implemented.");
  },
  async delete(_resource: string, _id: string): Promise<void> {
    throw new Error("DiscordClient.delete is not implemented.");
  },
};
