...
export const HubSpotClient: ApiClient = {
  serviceName: "HubSpot",
  ...
  quotaDefinitions: [
    { name: "crm.read", limit: 250000, windowSeconds: 86400 },
    { name: "crm.write", limit: 25000, windowSeconds: 86400 },
  ] satisfies QuotaDefinition[],
  async read(_resource: string, _params?: Record<string, string>): Promise<unknown> {
    throw new Error("HubSpotClient.read is not implemented.");
  },
  async create(_resource: string, _payload: unknown): Promise<unknown> {
    throw new Error("HubSpotClient.create is not implemented.");
  },
  async update(_resource: string, _id: string, _payload: unknown): Promise<unknown> {
    throw new Error("HubSpotClient.update is not implemented.");
  },
  async delete(_resource: string, _id: string): Promise<void> {
    throw new Error("HubSpotClient.delete is not implemented.");
  },
};
