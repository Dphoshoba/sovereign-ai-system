...
export default async function MinistryWorkspacePage() {
  const workspace = await getMinistryWorkspace("womanhood")
    ...
    return (
      <main style={pageStyle}>
        <section style={cardStyle}>
          ...
          <p style={bodyTextStyle}>The requested ministry workspace does not exist.</p>
        </section>
      </main>
    )
  }
    ...
    <main style={pageStyle}>
      <section style={headerStyle}>
        <div>
          ...
          <h1 style={titleStyle}>Ministry Workspace</h1>
          <p style={subtitleStyle}>Transform research missions into ministry resources in read-only preview mode.</p>
        </div>
      ...
      <section style={summaryGridStyle}>
        <MetricCard label="Related Research Mission" value={workspace.relatedResearchMission} detail={workspace.id} />
        <MetricCard label="Progress" value={`${workspace.progress}%`} detail="Resource completion" />
        <MetricCard label="Confidence" value={workspace.confidence} detail="Teaching confidence" />
      ...
      <section style={summaryGridStyle}>
        ...
        <MetricCard label="Lesson Count" value={String(workspace.lessonCount)} detail="Small-group resources" />
        <MetricCard label="Themes" value={String(workspace.themes.length)} detail="Tracked ministry themes" />
      </section>

      <section style={sectionStyle}>
        <h2 style={sectionTitleStyle}>Generated Ministry Outputs</h2>
        <div style={gridStyle}>
      ...
      <section style={footerStyle}>
        <Link href={`/ministry-workspace/${workspace.id}`} style={linkStyle}>
          Open mission ministry view
        </Link>
      </section>
    </main>
  )
