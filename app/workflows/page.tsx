...
import { getWorkflowRegistry } from "../../lib/gamma/workflow-reader"
  ...
  return (
    <main style={pageStyle}>
      <section style={cardStyle}>
        ...
        <h1 style={titleStyle}>Mission Workflows</h1>
        <p style={mutedStyle}>Automated workflow chains across missions.</p>
      </section>

      <section style={metricsStyle}>
        <Metric label="Workflow Count" value={String(registry.workflowCount)} />
        <Metric label="Automation Coverage" value={String(registry.automationCoverage)} />
        <Metric label="Execution Chains" value={String(registry.executionChains)} />
        <Metric label="Completion Rate" value={String(registry.completionRate)} />
        <Metric label="Dependency Count" value={String(registry.dependencyCount)} />
      ...
      <section style={gridStyle}>
        {registry.missions.map((mission) => (
          <article key={mission.mission} style={cardStyle}>
            ...
            <p style={mutedStyle}>Automation: {mission.automationCoverage}%</p>
            <Link href={`/workflows/${mission.mission}`} style={linkStyle}>View workflows</Link>
          </article>
        ))}
      </section>
    </main>
