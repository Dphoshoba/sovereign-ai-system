...
import { getAutonomyRegistry } from "../../lib/gamma/autonomy-reader"
  ...
  return (
    <main style={pageStyle}>
      <section style={cardStyle}>
        ...
        <h1 style={titleStyle}>System Autonomy</h1>
        <p style={mutedStyle}>Autonomous operation and decision making.</p>
      </section>
      ...
      <section style={metricsStyle}>
        ...
        <Metric label="Execution Capability" value={String(registry.executionCapability)} />
        <Metric label="Decision Capacity" value={String(registry.decisionCapacity)} />
      ...
      <section style={gridStyle}>
        {registry.missions.map((mission) => (
          <article key={mission.mission} style={cardStyle}>
            ...
            <p style={mutedStyle}>Autonomy: {mission.autonomyScore}</p>
            <Link href={`/autonomy/${mission.mission}`} style={linkStyle}>View autonomy</Link>
          </article>
        ))}
      </section>
    </main>
