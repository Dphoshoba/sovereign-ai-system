...
import { getSynthesisRegistry } from "../../lib/gamma/synthesis-reader"

export const dynamic = "force-dynamic"

export default async function SynthesisPage() {
  const registry = await getSynthesisRegistry()

  return (
    <main style={pageStyle}>
      <section style={cardStyle}>
        <p style={eyebrowStyle}>Synthesis Engine</p>
        <h1 style={titleStyle}>Knowledge Synthesis</h1>
        <p style={mutedStyle}>Cross-domain knowledge integration.</p>
      </section>

      <section style={metricsStyle}>
        <Metric label="Cross-Domain Links" value={String(registry.crossDomainLinks)} />
        <Metric label="Synthesis Count" value={String(registry.synthesisCount)} />
        <Metric label="Knowledge Density" value={String(registry.knowledgeDensity)} />
        <Metric label="Integration Score" value={String(registry.integrationScore)} />
      ...
      <section style={gridStyle}>
        {registry.missions.map((mission) => (
          <article key={mission.mission} style={cardStyle}>
            ...
            <p style={mutedStyle}>Integration: {mission.integrationScore}</p>
            <Link href={`/synthesis/${mission.mission}`} style={linkStyle}>View synthesis</Link>
          </article>
        ))}
      </section>
    </main>
