...
import { getMissionGammaSovereignOS } from "../../../lib/gamma/gamma-sovereign-os-reader"
...
export default async function GammaSovereignOSDetailPage({ params }: { params: { id: string } }) {
  const workspace = await getMissionGammaSovereignOS(params.id)

  if (!workspace) {
    return (
      <main style={pageStyle}>
        <section style={cardStyle}>
          <h1>Gamma sovereign OS not found</h1>
        </section>
      </main>
    )
  }
