...
import { getMarketIntelligenceRegistry } from "../../lib/gamma/market-intelligence-reader"

export const dynamic = "force-dynamic"

export default async function MarketIntelligencePage() {
  const registry = await getMarketIntelligenceRegistry()
  ...
  return (
    <main style={pageStyle}>
      <section style={cardStyle}>
        ...
        <p style={mutedStyle}>Market segments and demand analysis.</p>
      </section>

      <section style={metricsStyle}>
        <Metric label="Market Segments" value={String(registry.marketSegments)} />
        <Metric label="Audience Count" value={String(registry.audienceCount)} />
        <Metric label="Demand Score" value={String(registry.demandScore)} />
        <Metric label="Competition Score" value={String(registry.competitionScore)} />
        <Metric label="Opportunity Score" value={String(registry.opportunityScore)} />
      ...
      <section style={gridStyle}>
        {registry.missions.map((mission) => (
          <article key={mission.mission} style={cardStyle}>
            ...
            <p style={mutedStyle}>Demand: {mission.demandScore}%</p>
            <Link href={`/market-intelligence/${mission.mission}`} style={linkStyle}>View market</Link>
          </article>
        ))}
      </section>
    </main>
