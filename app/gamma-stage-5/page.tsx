        ...
        <aside className="space-y-6 lg:col-span-4">
          ...
          <section aria-labelledby="artifacts" className="rounded-md border border-zinc-800 bg-zinc-900/80 p-4">
            ...
            <div className="grid gap-2 text-sm">
              ...
              <Link
                href="/api/gamma/stage-5/release-governance-map"
                className="rounded-md border border-zinc-800 px-3 py-2 text-zinc-200 hover:border-cyan-500 hover:text-cyan-100"
              >
                Governance Map
              </Link>
              <Link
                href="/api/gamma/stage-5/release-decision-record"
                className="rounded-md border border-zinc-800 px-3 py-2 text-zinc-200 hover:border-cyan-500 hover:text-cyan-100"
              >
                Decision Record
              </Link>
              <Link
                href="/api/gamma/stage-5/release-approval-packet"
                className="rounded-md border border-zinc-800 px-3 py-2 text-zinc-200 hover:border-cyan-500 hover:text-cyan-100"
              >
                Approval Packet
              </Link>
              <Link
                href="/api/gamma/stage-5/release-promotion-plan"
                className="rounded-md border border-zinc-800 px-3 py-2 text-zinc-200 hover:border-cyan-500 hover:text-cyan-100"
              >
                Promotion Plan
              </Link>
              <Link
                href="/api/gamma/stage-5/release-cutover-checklist"
                className="rounded-md border border-zinc-800 px-3 py-2 text-zinc-200 hover:border-cyan-500 hover:text-cyan-100"
              >
                Cutover Checklist
              </Link>
              <Link
                href="/api/gamma/stage-5/release-traffic-shift-plan"
                className="rounded-md border border-zinc-800 px-3 py-2 text-zinc-200 hover:border-cyan-500 hover:text-cyan-100"
              >
                Traffic Shift Plan
              </Link>
              <Link
                href="/api/gamma/stage-5/release-monitoring-plan"
                className="rounded-md border border-zinc-800 px-3 py-2 text-zinc-200 hover:border-cyan-500 hover:text-cyan-100"
              >
                Monitoring Plan
              </Link>
              <Link
                href="/api/gamma/stage-5/release-post-promotion-review"
                className="rounded-md border border-zinc-800 px-3 py-2 text-zinc-200 hover:border-cyan-500 hover:text-cyan-100"
              >
                Post-Promotion Review
              </Link>
              <Link
                href="/api/gamma/stage-5/release-operations-index"
                className="rounded-md border border-zinc-800 px-3 py-2 text-zinc-200 hover:border-cyan-500 hover:text-cyan-100"
              >
                Operations Index
              </Link>
              <Link
                href="/api/gamma/stage-5/release-closeout-packet"
                className="rounded-md border border-zinc-800 px-3 py-2 text-zinc-200 hover:border-cyan-500 hover:text-cyan-100"
              >
                Closeout Packet
              </Link>
              ...
              <Link
                href="/api/gamma/stage-5/release-completion-certificate"
                className="rounded-md border border-zinc-800 px-3 py-2 text-zinc-200 hover:border-cyan-500 hover:text-cyan-100"
              >
                Completion Certificate
              </Link>
              <Link
                href="/api/gamma/stage-5/release-finalization-index"
                className="rounded-md border border-zinc-800 px-3 py-2 text-zinc-200 hover:border-cyan-500 hover:text-cyan-100"
              >
                Finalization Index
              </Link>
              <Link
                href="/api/gamma/stage-5/release-operator-registry"
                className="rounded-md border border-zinc-800 px-3 py-2 text-zinc-200 hover:border-cyan-500 hover:text-cyan-100"
              >
                Operator Registry
              </Link>
              <Link
                href="/api/gamma/stage-5/release-operator-action-queue"
                className="rounded-md border border-zinc-800 px-3 py-2 text-zinc-200 hover:border-cyan-500 hover:text-cyan-100"
              >
                Action Queue
              </Link>
              <Link
                href="/api/gamma/stage-5/release-operator-approval-packet"
                className="rounded-md border border-zinc-800 px-3 py-2 text-zinc-200 hover:border-cyan-500 hover:text-cyan-100"
              >
                Approval Packet
              </Link>
              <Link
                href="/api/gamma/stage-5/release-operator-approval-audit-trail"
                className="rounded-md border border-zinc-800 px-3 py-2 text-zinc-200 hover:border-cyan-500 hover:text-cyan-100"
              >
                Approval Audit
              </Link>
              <Link
                href="/api/gamma/stage-5/release-operator-approval-receipt"
                className="rounded-md border border-zinc-800 px-3 py-2 text-zinc-200 hover:border-cyan-500 hover:text-cyan-100"
              >
                Approval Receipt
              </Link>
              <Link
                href="/api/gamma/stage-5/release-production-authorization-ledger"
                className="rounded-md border border-zinc-800 px-3 py-2 text-zinc-200 hover:border-cyan-500 hover:text-cyan-100"
              >
                Authorization Ledger
              </Link>
              <Link
                href="/api/gamma/stage-5/release-production-cutover-packet"
                className="rounded-md border border-zinc-800 px-3 py-2 text-zinc-200 hover:border-cyan-500 hover:text-cyan-100"
              >
                Cutover Packet
              </Link>
