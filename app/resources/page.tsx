...
import { getResourceAllocationRegistry } from "../../lib/gamma/resource-allocation-reader"

export const dynamic = "force-dynamic"

export default async function ResourcesPage() {
  const registry = await getResourceAllocationRegistry()

  return (
    <main style={pageStyle}>
      <section style={cardStyle}>
        <p style={eyebrowStyle}>Resource Allocation</p>
        <h1 style={titleStyle}>Mission Resources</h1>
        <p style={mutedStyle}>Optimized resource allocation across missions.</p>
      </section>

      <section style={metricsStyle}>
        <Metric label="Resource Count" value={String(registry.resourceCount)} />
        <Metric label="Allocation Efficiency" value={String(registry.allocationEfficiency)} />
        <Metric label="Utilization Score" value={String(registry.utilizationScore)} />
        <Metric label="Capacity Score" value={String(registry.capacityScore)} />
        <Metric label="Optimization Score" value={String(registry.optimizationScore)} />
      ...
      <section style={gridStyle}>
        {registry.missions.map((mission) => (
          <article key={mission.mission} style={cardStyle}>
            ...
            <p style={mutedStyle}>Efficiency: {mission.allocationEfficiency}%</p>
            <Link href={`/resources/${mission.mission}`} style={linkStyle}>View resources</Link>
          </article>
        ))}
      </section>
    </main>
