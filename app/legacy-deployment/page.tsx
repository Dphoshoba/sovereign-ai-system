...
import { getLegacyDeploymentRegistry } from "../../lib/gamma/legacy-deployment-reader"
...
export default async function LegacyDeploymentPage() {
  const registry = await getLegacyDeploymentRegistry()

  return (
    <main style={pageStyle}>
      <section style={cardStyle}>
        <h1>Legacy Deployment</h1>
        <p>Intergenerational knowledge and impact transfer</p>
      </section>
      ...
      <section style={metricsStyle}>
        ...
        <div style={metricBoxStyle}>
          ...
          <div style={{ fontSize: "24px", fontWeight: "bold" }}>{registry.historicalConnection}</div>
        </div>
        <div style={metricBoxStyle}>
          <div style={{ fontSize: "12px", opacity: 0.6 }}>Inheritance Value</div>
          <div style={{ fontSize: "24px", fontWeight: "bold" }}>{registry.inheritanceValue}</div>
        </div>
        <div style={metricBoxStyle}>
        ...
        <div style={metricBoxStyle}>
          ...
          <div style={{ fontSize: "24px", fontWeight: "bold" }}>{registry.impact}</div>
        </div>
        <div style={metricBoxStyle}>
        ...
        {registry.missions.map((mission) => (
          <div key={mission.mission} style={missionCardStyle}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", marginTop: "8px" }}>
              <span>Legacy: {mission.legacyScore}</span>
