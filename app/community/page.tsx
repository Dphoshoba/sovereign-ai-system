...
import { getCommunityRegistry } from "../../lib/gamma/community-reader"

export const dynamic = "force-dynamic"

export default async function CommunityPage() {
  const registry = await getCommunityRegistry()

  return (
    <main style={pageStyle}>
      <section style={cardStyle}>
        <p style={eyebrowStyle}>Community Engine</p>
        <h1 style={titleStyle}>Community Building</h1>
        <p style={mutedStyle}>Engagement and network development.</p>
      </section>

      <section style={metricsStyle}>
        <Metric label="Community Count" value={String(registry.communityCount)} />
        <Metric label="Engagement Score" value={String(registry.engagementScore)} />
        <Metric label="Participation Score" value={String(registry.participationScore)} />
        <Metric label="Network Growth" value={String(registry.networkGrowth)} />
        <Metric label="Connection Strength" value={String(registry.connectionStrength)} />
      ...
      <section style={gridStyle}>
        {registry.missions.map((mission) => (
          <article key={mission.mission} style={cardStyle}>
            ...
            <p style={mutedStyle}>Engagement: {mission.engagementScore}%</p>
            <Link href={`/community/${mission.mission}`} style={linkStyle}>View community</Link>
          </article>
        ))}
      </section>
    </main>
