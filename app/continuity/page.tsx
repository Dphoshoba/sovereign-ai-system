...
import { getContinuityRegistry } from "../../lib/gamma/continuity-reader"
...
export default async function ContinuityPage() {
  const registry = await getContinuityRegistry()

  return (
    <main style={pageStyle}>
      <section style={cardStyle}>
        <h1>Continuity Engine</h1>
        <p>System resilience and seamless succession planning</p>
      </section>
      ...
      <section style={metricsStyle}>
        ...
        <div style={metricBoxStyle}>
          ...
          <div style={{ fontSize: "24px", fontWeight: "bold" }}>{registry.adaptabilityScore}</div>
        </div>
        <div style={metricBoxStyle}>
          <div style={{ fontSize: "12px", opacity: 0.6 }}>Successor Readiness</div>
          <div style={{ fontSize: "24px", fontWeight: "bold" }}>{registry.successorReadiness}</div>
        </div>
        <div style={metricBoxStyle}>
        ...
        <div style={metricBoxStyle}>
          ...
          <div style={{ fontSize: "24px", fontWeight: "bold" }}>{registry.recoveryCapacity}</div>
        </div>
        <div style={metricBoxStyle}>
        ...
        {registry.missions.map((mission) => (
          <div key={mission.mission} style={missionCardStyle}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", marginTop: "8px" }}>
              <span>Score: {mission.continuityScore}</span>
