...
export async function POST(req: NextRequest) {
  try {
    ...
    return NextResponse.json({
      ...
      systemName: "Adaptive Recursive Governance Infrastructure",
      phaseTwoSummary: {
        status: "complete",
        recursiveMetaAdaptationScore:
          metaAdaptation.recursiveMetaAdaptationScore,
        ...
        finalDirective:
          "Safely evolve recursive governance, safeguards, healing and stability without weakening constitutional alignment.",
      },
      stack: {
        metaAdaptation,
        arbitration,
    ...
    console.error("Phase two recursive synthesis failed:", error)

    return NextResponse.json(
      {
        ok: false,
        error: "Phase two recursive synthesis failed",
      },
      {
        status: 500,
      }
