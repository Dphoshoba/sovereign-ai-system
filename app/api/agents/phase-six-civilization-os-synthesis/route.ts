...
export async function POST(req: NextRequest) {
  try {
    ...
    return NextResponse.json({
      ...
      systemName: "Civilization Operating System",
      phaseSixSummary: {
        status: "complete",
        recursiveOSKernelScore:
          osKernel.recursiveOSKernelScore,
        ...
        dominantTrustInfrastructure:
          trustInfrastructure.dominantTrustInfrastructure.infrastructure,
        finalDirective:
          "Operate civilization intelligence through recursive governance runtime, controlled APIs, institutional agents and distributed trust infrastructure.",
      },
      stack: {
        osKernel,
        civilizationAPI,
    ...
    console.error("Phase six civilization OS synthesis failed:", error)

    return NextResponse.json(
      {
        ok: false,
        error: "Phase six civilization OS synthesis failed",
      },
      { status: 500 }
    )
  }
