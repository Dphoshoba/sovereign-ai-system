...
export async function POST(req: NextRequest) {
  try {
    ...
    return NextResponse.json({
      ...
      systemName:
        "Autonomous Media Civilization Engine",
      phaseFourSummary: {
        status: "complete",
        ...
        finalDirective:
          "Scale civilization-positive autonomous media infrastructure through wisdom, trust, flourishing and long-horizon narrative alignment.",
      },
    ...
    console.error(
      "Phase four recursive synthesis failed:",
      error
    )
