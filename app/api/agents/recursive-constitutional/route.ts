...
export async function POST(req: NextRequest) {
  try {
    ...
    const result = recursiveConstitutionalAgent({
    ...
    console.error("Recursive constitutional intelligence failed:", error)

    return NextResponse.json(
      {
        ok: false,
        error: "Recursive constitutional intelligence failed",
      },
      {
        status: 500,
      }
