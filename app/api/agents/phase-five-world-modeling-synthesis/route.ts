...
export async function POST(req: NextRequest) {
  try {
    ...
    return NextResponse.json({
      ...
      systemName: "Recursive World Modeling Intelligence",
      phaseFiveSummary: {
        status: "complete",
        recursiveWorldModelGenesisScore:
          worldModelGenesis.recursiveWorldModelGenesisScore,
        ...
        dominantWorldModelDomain:
          worldModelGenesis.dominantWorldModelDomain.domain,
        dominantForecast:
          civilizationForecasting.dominantForecast.scenario,
        dominantSimulation:
          scenarioSimulation.dominantSimulation.simulation,
        dominantTrajectory:
          trajectoryEvaluation.dominantTrajectory.trajectory,
        dominantForesight:
          strategicForesight.dominantForesight.foresight,
        finalDirective:
          "Model civilization futures with humility, truthfulness, wisdom, flourishing and long-horizon governance alignment.",
      },
      stack: {
        worldModelGenesis,
        civilizationForecasting,
        scenarioSimulation,
    ...
    console.error("Phase five world modeling synthesis failed:", error)

    return NextResponse.json(
      {
        ok: false,
        error: "Phase five world modeling synthesis failed",
      },
      { status: 500 }
    )
  }
