...
export async function POST(req: NextRequest) {
  try {
    ...
    const result = recursivePlanetaryCommunityResilienceAgent({
    ...
    console.error("Recursive planetary community resilience failed:", error)

    return NextResponse.json(
      {
        ok: false,
        error: "Recursive planetary community resilience failed",
      },
      { status: 500 }
    )
  }
