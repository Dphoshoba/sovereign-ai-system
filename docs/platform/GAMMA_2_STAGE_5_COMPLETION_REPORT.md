...
- `npm run smoke:v1` - 68 routes passed, 0 failed
...
- Stage 5 release governance map is exposed at `/api/gamma/stage-5/release-governance-map`.
- Stage 5 release decision record is exposed at `/api/gamma/stage-5/release-decision-record`.
- Stage 5 release approval packet is exposed at `/api/gamma/stage-5/release-approval-packet`.
- Stage 5 release promotion plan is exposed at `/api/gamma/stage-5/release-promotion-plan`.
- Stage 5 release cutover checklist is exposed at `/api/gamma/stage-5/release-cutover-checklist`.
- Stage 5 release traffic shift plan is exposed at `/api/gamma/stage-5/release-traffic-shift-plan`.
- Stage 5 release monitoring plan is exposed at `/api/gamma/stage-5/release-monitoring-plan`.
- Stage 5 release post-promotion review is exposed at `/api/gamma/stage-5/release-post-promotion-review`.
- Stage 5 release operations index is exposed at `/api/gamma/stage-5/release-operations-index`.
- Stage 5 release closeout packet is exposed at `/api/gamma/stage-5/release-closeout-packet`.
- Stage 5 release closure ledger is exposed at `/api/gamma/stage-5/release-closure-ledger`.
- Stage 5 release completion certificate is exposed at `/api/gamma/stage-5/release-completion-certificate`.
- Stage 5 release finalization index is exposed at `/api/gamma/stage-5/release-finalization-index`.
- Stage 5 release operator registry is exposed at `/api/gamma/stage-5/release-operator-registry`.
- Stage 5 release operator action queue is exposed at `/api/gamma/stage-5/release-operator-action-queue`.
- Stage 5 release operator approval packet is exposed at `/api/gamma/stage-5/release-operator-approval-packet`.
- Stage 5 release operator approval audit trail is exposed at `/api/gamma/stage-5/release-operator-approval-audit-trail`.
- Stage 5 release operator approval receipt is exposed at `/api/gamma/stage-5/release-operator-approval-receipt`.
- Stage 5 release production authorization ledger is exposed at `/api/gamma/stage-5/release-production-authorization-ledger`.
- Stage 5 release production cutover packet is exposed at `/api/gamma/stage-5/release-production-cutover-packet`.
